...
export default function CandidateForm(props) {
    ...
    return (
        <CandidateFormCard onSubmit={props.applyToTrip}>
            ...
            <h3>Nome</h3>
            <input name="name" type="text" value ={props.form.name} onChange={props.onChange} pattern="{3,}" required />
            
            <h3>Idade</h3>
            <input name="age" type="number" min="18" value ={props.form.age} onChange={props.onChange} required />
            
            <h3>Texto de Candidatura</h3>
            <input name="applicationText" type="text" value ={props.form.applicationText} onChange={props.onChange} pattern="{30,}" required />
            
            <h3>Profissão</h3>
            <input name="profession" type="text" value ={props.form.profession} onChange={props.onChange} pattern="{10,}" required />
